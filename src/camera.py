...
class CameraManager:
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        self.sensors = [
            ...
            ["sensor.camera.depth", carla.ColorConverter.LogarithmicDepth, "Camera Depth (Logarithmic)", {}],
            ["sensor.camera.semantic_segmentation", carla.ColorConverter.Raw, "Camera Semantic Segmentation", {}],
            [
